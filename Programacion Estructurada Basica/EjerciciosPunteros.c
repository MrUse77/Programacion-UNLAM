...
void Carga3(int *a, float *b, char *c){
    printf("Ingrese un valor entero: "); scanf("%d", a);
    printf("Ingrese un valor flotante: "); scanf("%f", b);
...
void ej5(){
    ...
    Mostrar4(vector, 10);
    do{
        printf("Ingrese el numero a buscar: "); scanf("%d", &num);
...
void ej7(){
    ...
    pProducto = &producto;
    printf("Ingrese el codigo del producto: "); scanf("%d", &pProducto->codigo);

    printf("Ingrese la descripcion del producto: "); fsgetsP(pProducto->descripcion, 31);
    printf("Ingrese el precio del producto: "); scanf("%f", &pProducto->precio);
    printf("Codigo: %d\n", pProducto->codigo);
...
int Cargar8(alumno *alu, int n){
    int i;
    for(i=0;i<n;i++){
        printf("Ingrese el nombre del alumno: "); fsgetsP(alu->nom, 31);
        printf("Ingrese el DNI del alumno: "); scanf("%d", &alu->dni);
        if(alu->dni<0){
            return i;
        }
        alu++;
